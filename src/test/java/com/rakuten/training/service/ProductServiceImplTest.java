...
public class ProductServiceImplTest {
	...
	@Test
	public void addNewProduct_Returns_Product_With_Valid_Id_When_ProductValue_GTEQ_MinValue() {
		// Arrange
	...
	public void removeProduct_Throws_IllegalArgumentException_When_ProductValue_GT_MinValue() { // Arrange
		ProductServiceImpl service = new ProductServiceImpl();
		Product existing = new Product("test", 1099908, 1); // notice 10000*1 >=10000 existing.setId(1);
		ProductDAO mockDAO = Mockito.mock(ProductDAO.class);
		Mockito.when(mockDAO.findById(1)).thenThrow(new IllegalStateException());
		service.setDao(mockDAO); // Mockito.verify(mockDAO).deleteById(1);
	...
	public void removeProduct_Removes_When_ProductValue_LT_MinValue() {
		// Arrange
		ProductServiceImpl service = new ProductServiceImpl();
		Product existing = new Product("test", 99999, 1); // notice 999*1 <10000
		existing.setId(1);
		ProductDAO mockDAO = Mockito.mock(ProductDAO.class);
	...
	public void removeProduct_Throws_NullPointer_If_Product_Does_Not_Exist() {
		ProductServiceImpl service = new ProductServiceImpl();
		ProductDAO mockDAO = Mockito.mock(ProductDAO.class);
